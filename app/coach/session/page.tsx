...
function OptionCard({ selected, onClick, label: text, desc }: {
  ...
  return (
    ...
    >
      <p style={{ margin: 0, fontSize: "13px", fontWeight: 600,
        color: selected ? "var(--accent)" : "var(--text)" }}>{text}</p>
...
export default function SessionPage() {
      ...
      <div className="cf-page-narrow">
        <div style={{ marginBottom: "32px" }}>
          <p style={{ fontSize: "11px", letterSpacing: "0.12em", textTransform: "uppercase",
            color: "var(--text-muted)", marginBottom: "6px" }}>concept//session</p>
        ...
        <PlanSection title="Main set">
          ...
          {/* Highlighted coaching cues */}
          <div style={{
            padding: "14px 16px", borderRadius: "8px", marginBottom: "16px",
            background: "var(--surface-2)", border: "1px solid var(--accent)",
            borderLeft: "3px solid var(--accent)",
          }}>
            <p style={{ fontSize: "10px", fontWeight: 700, color: "var(--accent)",
              letterSpacing: "0.14em", textTransform: "uppercase", margin: "0 0 10px" }}>
              Session cues
            </p>
            {plan.main_set.cues.map((c, i) => (
              <p key={i} style={{ margin: "0 0 6px", fontSize: "13px", fontWeight: 600,
                color: "var(--text)", lineHeight: 1.5, paddingLeft: "14px", position: "relative" }}>
                <span style={{ position: "absolute", left: 0, color: "var(--accent)" }}>·</span>
                {c}
              </p>
            ))}
          ...
          <p style={{ fontSize: "12px", fontWeight: 600, color: "var(--text-muted)",
            margin: "0 0 6px", letterSpacing: "0.05em" }}>COMMON ERRORS</p>
  ...
  return (
    <div className="cf-page-narrow">
      ...
      {step === 0 && (
        <div>
          <span style={lbl}>Choose discipline</span>
      ...
      {step === 1 && discipline && (
        <div>
          <span style={lbl}>Choose event</span>
          <div style={grid}>
      ...
      {step === 2 && (
        <div>
          ...
          <span style={lbl}>Ability level</span>
          ...
          <span style={lbl}>Group size</span>
          <div style={grid}>
            {GROUP_SIZES.map(g => (
      ...
      {step === 5 && (
        <div>
          <span style={lbl}>Ready to generate</span>
          {[
